...
ImageAvatar.args = {
  alt: '이미지 아바타',
  src: 'https://www.gravatar.com/avatar/f3d7d59de4dbf202811b5d9d2d660746'
};

export const SizeAvatar = Template.bind({});
SizeAvatar.args = {
  alt: '사이즈 아바타',
  src: 'https://www.gravatar.com/avatar/f3d7d59de4dbf202811b5d9d2d660746',
  size: 100
...
export const SuffixAvatar = Template.bind({});
SuffixAvatar.args = {
  alt: '아이콘 아바타',
  suffix: <span>아바타</span>
};
